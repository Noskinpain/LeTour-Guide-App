...
const Filter = () => {
    ...
    return (
        <div className="hidden md:flex items-center p-2 absolute bottom-0 z-10 w-[50%] lg:w-[25%]">
            <div className="shadow-md rounded-sm bottom-0 bg-black p-3 text-sm w-full space-y-2">
                <h2 className="font-semibold text-white flex items-center text-2xl">
                    <svg className="h-7 w-7 mr-1 text-white my-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M3 3a1 1 0 011-1h12a1 1 0 011 1v3a1 1 0 01-.293.707L12 11.414V15a1 1 0 01-.293.707l-2 2A1 1 0 018 17v-5.586L3.293 6.707A1 1 0 013 6V3z" clipRule="evenodd" />
                    </svg>
                    Filter
                </h2>
                <div className="w-full text-white space-y-1 font-medium">
                    <p>Place Type</p>
                    ...
                    <select
                        ...
                        className="focus:ring-2 focus:ring-blue-500 text-black focus:outline-none rounded-md border border-gray-300 w-full p-2"
                    >
